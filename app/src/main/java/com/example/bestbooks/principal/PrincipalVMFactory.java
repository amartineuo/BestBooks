 ...
 * {@link BookRepository}
 */
public class PrincipalVMFactory extends ViewModelProvider.NewInstanceFactory{

    private final BookRepository mBookRepository;

    public PrincipalVMFactory(BookRepository bookRepository) {
        this.mBookRepository = bookRepository;
    }

    @Override
    public <T extends ViewModel> T create(Class<T> modelClass) {
        return (T) new PrincipalViewModel(mBookRepository);
    }
}
