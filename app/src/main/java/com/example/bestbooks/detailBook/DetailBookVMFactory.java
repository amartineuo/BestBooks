 ...
 */
public class DetailBookVMFactory extends ViewModelProvider.NewInstanceFactory{

    private final UserRepository mUserRepository;
    private final BookRepository mBookRepository;
    private final FavoriteRepository mFavoriteRepository;

    public DetailBookVMFactory(UserRepository userRepository, BookRepository bookRepository, FavoriteRepository favoriteRepository) {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        return (T) new DetailBookViewModel(mUserRepository, mBookRepository, mFavoriteRepository);
    }
}
